...
import com.cb.SmartGroups.utils.dialogs.commondialogs.DisplayParticipantsListDialog;
import com.cb.SmartGroups.utils.firesoredatamodels.Group;
import com.cb.SmartGroups.utils.cards.PetitionCard;
...
public class PetitionGroupCardAdapter extends RecyclerView.Adapter<PetitionGroupCardAdapter.PetitionGroupCardViewHolder> {
    ...
    public void onBindViewHolder(@NonNull PetitionGroupCardViewHolder holder, int position) {
        ...
        if (petitionCard.getRequesterId().equals(fAuth.getUid())) {
            ...
            String petitionTitile = "Request for "+ petitionCard.getRequesterName();
    ...
    private void createNewGroup(String selectedCourse, String selectedSubject, DocumentSnapshot documentSnapshot) {
        ...
        groupsCollRef
                ...
                .addOnSuccessListener(queryDocumentSnapshots -> {
                    ...
                    Group.createGroup(groupsCollRef, selectedCourse, selectedSubject, petition.getPetitionUsersIds(), maxGroupIdentifier + 1, context, documentSnapshot.getReference(), null, null);
                });
