package com.cb.SmartGroups.adapters.recyclerviews.interactivity.student;
...
import com.cb.SmartGroups.utils.cards.interactivity.studentcards.ReminderCard;
    ...
    public void onBindViewHolder(@NonNull @NotNull RecyclerView.ViewHolder holder, int position) {
        ...
        switch (holder.getItemViewType()) {
                                ...
                                .addOnSuccessListener(unused -> {
                                    documentReference
                                            ...
                                            .addOnSuccessListener(unused1 -> {
                                                Toast.makeText(context, "Answer sent successfully", Toast.LENGTH_SHORT).show();
                                            });
                                });
                    }
                });
            ...
            case InteractivityCardType.TYPE_STANDBY:
                ...
                String spokerNameAndMessageText = "Discuss the correct answer with your classmates. When you are clear, ask " + standbyCard.getSpokerName() + " to answer the following questions";
