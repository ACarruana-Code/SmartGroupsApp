...
import com.cb.SmartGroups.utils.utilities.EmailValidation;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        login.setOnClickListener(view -> {
            if (fieldsOk()) {
                ...
                Toast.makeText(getApplicationContext(), "Error logging in. Please check the validity of the fields", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void checkUserAccessLevel(String uid) {
        ...
        df.get().addOnCompleteListener(task -> {
            if (task.isSuccessful()) {
                ...
                Toast.makeText(getApplicationContext(), "Error checking permissions", Toast.LENGTH_SHORT).show();
            }
        });
    }
