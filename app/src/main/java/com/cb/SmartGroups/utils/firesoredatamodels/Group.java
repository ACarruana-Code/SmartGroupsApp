...
public class Group {
    ...
    public static void createGroup(CollectionReference groupsCollRef, String selectedCourse, String selectedSubject, List<String> studentIDs, int identifier, Context context, DocumentReference petitionDocument, String spokesStudentID, String pattern) {
                                ...
                                if (collectionRefID.equals("CollectiveGroups")) {
                                    ...
                                    fStore
                                            ...
                                            .addOnSuccessListener(documentSnapshot -> {
                                                ...
                                                CollectiveGroupDocument newCollectiveGroupDocument = new CollectiveGroupDocument("Group " + identifier, studentsAndTeacherIDs, groups, spokerID, spokerName, pattern);
                                                ...
                                                groupsCollRef
                                                        ...
                                                        .addOnSuccessListener(queryDocumentSnapshots -> {
                                                            ...
                                                            if (groupExists) {
                                                                Toast.makeText(context, "Such a group already exists (Group " + (identifier - 1) + ")", Toast.LENGTH_SHORT).show();
                                                            } else {
                                    ...
                                    fStore
                                            ...
                                            .addOnSuccessListener(documentSnapshot -> {
                                                ...
                                                studentsAndTeacherGroup.setName("Chat with " + studentName);
                                                IndividualGroupDocument newGroupDocument = new IndividualGroupDocument("Chat with " + studentName, studentsAndTeacherIDs, studentsAndTeacherGroup);
